...
module.exports = "<h1> {{title}}</h1>\n\n<div *ngFor=\"let pregunta of preguntas;index as i;first as first\">\n<span *ngIf=\"first\" >{{pregunta.pregunta}}</span>\n</div>\n"
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__pregunta_service__ = __webpack_require__(83);
...
var AppComponent = (function () {
    function AppComponent(servicio) {
        ...
        this.title = 'Entrenador Angular 4!';
    }
    AppComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.servicio.todosReactivos()
            .subscribe(function (stats) {
            console.log(stats.json());
            _this.preguntas = stats.json();
        });
    };
    return AppComponent;
}());
AppComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_1__pregunta_service__["a" /* PreguntaService */]]
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__pregunta_service__["a" /* PreguntaService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__pregunta_service__["a" /* PreguntaService */]) === "function" && _a || Object])
], AppComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_clarity_angular__ = __webpack_require__(85);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return PreguntaService; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var PreguntaService = (function () {
    ...
    PreguntaService.prototype.todosReactivos = function () {
        return this.http.get('http://localhost:9001/tema/B2');
    };

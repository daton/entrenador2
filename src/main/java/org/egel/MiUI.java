...
@Autowired RepositorioBinario repo;
@Autowired RepositorioPregunta repositorioPregunta;
@Autowired ServicioCorreo servicioCorreo;
@Autowired RepositorioAlumno repositorioAlumno;
...
// AGREGAMOS LA INTERFAZ INICIAL del proyecto hay estoy prepcupadodsdsds
